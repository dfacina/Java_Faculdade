...
public class CalcularValor implements ActionListener{  
    ...
    CalcularValor(){  
        ...
        tf1=new JTextField();  //Caixa de texto para por o numero 1
        tf1.setBounds(100,50, 150,20);

        l2=new JLabel("Numero2 :");  
        l2.setBounds(35,100, 150,20);

        tf2=new JTextField();  //Caixa de texto para por o numero 2
        tf2.setBounds(100,100, 150,20);

        b1=new JButton("Somar");  //Botão Somar
        ...
        */
        ...
        l4=new JLabel();  //Resultado por texto fixo
